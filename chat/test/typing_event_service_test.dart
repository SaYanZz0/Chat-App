...
import 'package:chat/src/services/typing_event/typing_event_implem.dart';
import 'package:chat/src/services/user/user_services_contract.dart';
...
void main() {
  ...
  setUp(() async {
    ...
    sut = TypingNotificationService(r, connection, userService);
  });
